...
item.save!
item = Item.new(user_id: 4, price: 99, name: "Tent", description: "Staying in a hotel is so last year - why not get your friends and family together for a camping holiday instead? This is a pop-up tent that is also easy-to-carry, for one or two people, all the way up to a family of 6.", category: "Outdoor", remote_photo_url: "https://cdn.pixabay.com/photo/2017/08/16/10/44/teepee-2647263_1280.jpg", address: "Jl. Danau Tamblingan 168 - 170, Denpasar, Bali, 80228, Indonesia", latitude: -8.696594, longitude: 115.263442, published: true)
item.save!
item = Item.new(user_id: 3, price: 50, name: "Skis", description: "Designed for advanced skiers on groomed slopes. Suited to 90% carving slopes, and 10% all types of snow, they are forgiving and easy to handle, making them a very good tool for learning to carve in very good conditions.", category: "Snow", remote_photo_url: "https://images.pexels.com/photos/257961/pexels-photo-257961.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", address: "Jln. Bayam No. 495, Tegal 65269, Bali", latitude: -8.340539, longitude: 115.091951, published: true)
item.save!
